...
public class PageTwo extends WizardPage {
	...
	private static final String DESCRIPTION = "Labview Import Wizard: Check caculation results and confirm";
			...
			public void doubleClick(DoubleClickEvent event) {
				...
				new TitleAreaDialog(container.getShell()) {
					...
					protected Control createDialogArea(Composite parent) {
						...
						ScrolledComposite composite = new ScrolledComposite(marginComposite,
						...
						try {
							ECPSWTView view = ECPSWTViewRenderer.INSTANCE.render(composite, (EObject) selectedElement);
