...
public class ConfirmRefreshDialog extends TitleAreaDialog {
  ...
  private void getAllChildren(ITreeContentProvider provider, Object element,
    ...
    public Object[] getChildren(Object parentElement) {
      ...
      if (parentElement instanceof Match) {
        ...
        children.addAll(((Match) parentElement).getSubmatches().stream().filter(match -> {
          ...
          return allSubmatches.stream()
              .filter(submatch -> submatch.getDifferences().isEmpty() == false).findAny()
              .isPresent();
